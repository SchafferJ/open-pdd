...
#[derive(Debug, Serialize)]
pub struct PddStockWareUpdateRequest {
    /// 货品id
    pub id: i64,
    /// 类型 0:单独货品。1:组合货品
    pub ware_type: i32,
...
impl RequestType for PddStockWareUpdateRequest {
    type Response = PddStockWareUpdateResponse;

    fn get_type(&self) -> &'static str {
        "pdd.stock.ware.update"
    }
}

#[derive(Debug, Deserialize)]
pub struct PddStockWareUpdateResponse;
