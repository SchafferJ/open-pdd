...
pub struct PddOrderNumberListIncrementGetRequest {
...
impl RequestType for PddOrderNumberListIncrementGetRequest {
    type Response = PddOrderNumberListIncrementGetResponse;
...
#[derive(Debug, Deserialize)]
pub struct PddOrderNumberListIncrementGetResponse {
    /// 是否有下一页
    #[serde(default)]
    pub has_next: bool,
    /// 订单列表对象
    #[serde(default)]
    pub order_sn_list: Option<Vec<OrderSn>>,
    /// 返回订单的总数
    #[serde(default)]
    pub total_count: i32,
}
