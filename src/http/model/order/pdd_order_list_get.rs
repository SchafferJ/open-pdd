...
pub struct PddOrderListGetRequest {
...
impl RequestType for PddOrderListGetRequest {
    type Response = PddOrderListGetResponse;
...
#[derive(Debug, Deserialize)]
pub struct PddOrderListGetResponse {
    /// 是否存在下一页
    #[serde(default)]
    pub has_next: bool,
    /// 订单信息列表
