...
pub struct BookingNotice {
    ...
    /// 换票时间
    pub ticket_time: Vec<TicketTime>,
}
...
pub struct ProviderContactInfo {
    /// 服务时间
    pub provider_business_hour: Vec<ProviderBusinessHour>,
    /// 服务商名称
...
pub struct RefundLimitations {
    ...
    /// 退款规则
    pub refund_rules: Vec<RefundRules>,
}
...
#[derive(Debug, Serialize)]
pub struct PddTicketSkuRuleEditRequest {
    /// 下单人信息设置
...
impl RequestType for PddTicketSkuRuleEditRequest {
    type Response = PddTicketSkuRuleEditResponse;

    fn get_type(&self) -> &'static str {
        "pdd.ticket.sku.rule.edit"
    }
}

#[derive(Debug, Deserialize)]
pub struct PddTicketSkuRuleEditResponse {
    /// 规则 ID
    #[serde(default)]
    pub rule_id: String,
    /// 版本
