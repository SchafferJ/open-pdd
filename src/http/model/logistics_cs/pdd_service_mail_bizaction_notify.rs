...
impl RequestType for PddServiceMailBizactionNotifyRequest {
    type Response = PddServiceMailBizactionNotifyResponse;

    fn get_type(&self) -> &'static str {
        "pdd.service.mail.bizaction.notify"
    }
...
pub struct PddServiceMailBizactionNotifyResponse {
