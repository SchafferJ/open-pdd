...
#[derive(Debug, Serialize)]
pub struct PddGoodsSizespecTemplateUpdateRequest {
    /// 尺码表
    pub size_spec_dto: SizeSpecDto,
}

impl RequestType for PddGoodsSizespecTemplateUpdateRequest {
    type Response = PddGoodsSizespecTemplateUpdateResponse;

    fn get_type(&self) -> &'static str {
        "pdd.goods.sizespec.template.update"
    }
}

#[derive(Debug, Deserialize)]
pub struct PddGoodsSizespecTemplateUpdateResponse {
    /// 错误码
    #[serde(default)]
    pub error_code: i32,
    /// 错误描述
