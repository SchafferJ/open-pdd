...
#[derive(Debug, Serialize)]
pub struct PddGoodsSubmitGoodsCommitRequest {
    /// 是否自动补充标品属性
...
impl RequestType for PddGoodsSubmitGoodsCommitRequest {
    type Response = PddGoodsSubmitGoodsCommitResponse;
...
pub struct PddGoodsSubmitGoodsCommitResponse {
    /// 提交申请的序列id
    #[serde(default)]
    pub goods_commit_id: i64,
    /// 商品id
