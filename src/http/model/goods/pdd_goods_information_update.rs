...
#[derive(Debug, Serialize)]
pub struct PddGoodsInformationUpdateRequest {
    /// 是否自动补充标品属性
...
impl RequestType for PddGoodsInformationUpdateRequest {
    type Response = PddGoodsInformationUpdateResponse;
...
pub struct PddGoodsInformationUpdateResponse {
    /// 提交申请的序列id
    #[serde(default)]
