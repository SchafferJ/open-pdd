...
pub struct PddGoodsAddRequest {
    ...
    /// 是否支持开票（测试中）
    pub invoice_status: Option<bool>,
...
impl RequestType for PddGoodsAddRequest {
    type Response = PddGoodsAddResponse;
...
pub struct PddGoodsAddResponse {
    /// 上传商品的上传序列ID
    #[serde(default)]
