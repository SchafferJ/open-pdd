...
#[derive(Debug, Serialize)]
pub struct PddGoodsLogisticsSerTemplateUpdateRequest {
...
impl RequestType for PddGoodsLogisticsSerTemplateUpdateRequest {
    type Response = PddGoodsLogisticsSerTemplateUpdateResponse;

    fn get_type(&self) -> &'static str {
        "pdd.goods.logistics.ser.template.update"
    }
}

#[derive(Debug, Deserialize)]
pub struct PddGoodsLogisticsSerTemplateUpdateResponse {
    /// 模版id
    #[serde(default)]
    pub template_id: String,
}
