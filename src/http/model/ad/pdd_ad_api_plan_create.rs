...
#[derive(Debug, Serialize)]
pub struct PddAdApiPlanCreateRequest {
    /// 计划创建信息
    #[serde(rename = "adPlanCreateMessage")]
    pub ad_plan_create_message: AdPlanCreateMessage,
    /// 单元创建信息列表
    #[serde(rename = "adUnitCreateComplexMessageList")]
    pub ad_unit_create_complex_message_list: Option<Vec<AdUnitCreateComplexMessage>>,
...
impl RequestType for PddAdApiPlanCreateRequest {
    type Response = PddAdApiPlanCreateResponse;
...
pub struct PddAdApiPlanCreateResponse {
