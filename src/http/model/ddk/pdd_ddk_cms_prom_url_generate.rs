...
pub struct PddDdkCmsPromUrlGenerateRequest {
...
impl RequestType for PddDdkCmsPromUrlGenerateRequest {
    type Response = PddDdkCmsPromUrlGenerateResponse;
...
#[derive(Debug, Deserialize)]
pub struct PddDdkCmsPromUrlGenerateResponse {
    /// total
    #[serde(default)]
    pub total: i32,
    /// 链接列表
