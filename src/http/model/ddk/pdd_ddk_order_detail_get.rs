...
pub struct PddDdkOrderDetailGetRequest {
    /// 订单号
    pub order_sn: String,
    /// 订单类型：1-推广订单；2-直播间订单
...
impl RequestType for PddDdkOrderDetailGetRequest {
    type Response = PddDdkOrderDetailGetResponse;
...
pub struct PddDdkOrderDetailGetResponse {
