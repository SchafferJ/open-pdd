...
pub struct PddDdkOrderListRangeGetRequest {
...
impl RequestType for PddDdkOrderListRangeGetRequest {
    type Response = PddDdkOrderListRangeGetResponse;
...
#[derive(Debug, Deserialize)]
pub struct PddDdkOrderListRangeGetResponse {
    /// last_order_id
    #[serde(default)]
