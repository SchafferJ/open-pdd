...
#[derive(Debug, Serialize)]
pub struct PddDdkGoodsSearchRequest {
...
impl RequestType for PddDdkGoodsSearchRequest {
    type Response = PddDdkGoodsSearchResponse;
...
#[derive(Debug, Deserialize)]
pub struct PddDdkGoodsSearchResponse {
    /// 商品列表
    #[serde(default)]
