...
#[derive(Debug, Serialize)]
pub struct DiyPromoActCollectionParam {
...
#[derive(Debug, Serialize)]
pub struct PddDdkOauthRpPromUrlGenerateRequest {
    ...
    /// 大促会场集合页参数
    pub diy_promo_act_collection_param: Option<DiyPromoActCollectionParam>,
    /// 红包自定义参数，json格式
...
impl RequestType for PddDdkOauthRpPromUrlGenerateRequest {
    type Response = PddDdkOauthRpPromUrlGenerateResponse;
...
#[derive(Debug, Deserialize)]
pub struct PddDdkOauthRpPromUrlGenerateResponse {
    /// resource_list
    #[serde(default)]
