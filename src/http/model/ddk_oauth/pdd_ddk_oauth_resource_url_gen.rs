...
pub struct PddDdkOauthResourceUrlGenRequest {
...
impl RequestType for PddDdkOauthResourceUrlGenRequest {
    type Response = PddDdkOauthResourceUrlGenResponse;

    fn get_type(&self) -> &'static str {
        "pdd.ddk.oauth.resource.url.gen"
    }
}
...
#[derive(Debug, Deserialize)]
pub struct PddDdkOauthResourceUrlGenResponse {
    /// 多人团链接
    #[serde(default)]
