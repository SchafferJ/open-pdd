...
pub struct PddDdkOauthGoodsRecommendGetRequest {
...
impl RequestType for PddDdkOauthGoodsRecommendGetRequest {
    type Response = PddDdkOauthGoodsRecommendGetResponse;
...
#[derive(Debug, Deserialize)]
pub struct PddDdkOauthGoodsRecommendGetResponse {
    /// 列表
    #[serde(default)]
