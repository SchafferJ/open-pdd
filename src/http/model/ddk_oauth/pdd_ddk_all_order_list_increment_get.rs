...
pub struct PddDdkAllOrderListIncrementGetRequest {
...
impl RequestType for PddDdkAllOrderListIncrementGetRequest {
    type Response = PddDdkAllOrderListIncrementGetResponse;
...
#[derive(Debug, Deserialize)]
pub struct PddDdkAllOrderListIncrementGetResponse {
    /// 多多进宝推广位对象列表
    #[serde(default)]
