...
pub struct PddDdkOauthGoodsDetailRequest {
...
impl RequestType for PddDdkOauthGoodsDetailRequest {
    type Response = PddDdkOauthGoodsDetailResponse;

    fn get_type(&self) -> &'static str {
        "pdd.ddk.oauth.goods.detail"
    }
}
...
#[derive(Debug, Deserialize)]
pub struct PddDdkOauthGoodsDetailResponse {
    /// 多多进宝商品对象列表
    #[serde(default)]
